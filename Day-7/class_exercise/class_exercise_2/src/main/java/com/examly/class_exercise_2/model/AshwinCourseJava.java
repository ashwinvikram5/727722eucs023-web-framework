...
public class AshwinCourseJava {
     ...
     public AshwinCourseJava() {

     }

     public AshwinCourseJava(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
