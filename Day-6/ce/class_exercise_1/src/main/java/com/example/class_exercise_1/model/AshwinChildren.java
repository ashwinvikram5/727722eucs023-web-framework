...
public class AshwinChildren {
     ...
     public AshwinChildren() {

     }

     public AshwinChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
